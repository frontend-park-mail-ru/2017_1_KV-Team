...
// Передаем поле для валидации (внутри формы) и сообщение об ошибке, если третьего параметра нет, то идет проверка на
// путое поле
...
// Можно передовать несколько полей в массиве, ошибка выводится у первого поля, функция принимает столько параметров
// сколько полей
